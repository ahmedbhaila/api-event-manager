...
public class EventDaoTest {
	...
	public void testDeleteEvent() throws EventException {
		...
		// get all events
		List<Event> events = eventDao.getAll(1, 1, null);
		...
		events = eventDao.getAll(1, 1, null);
	...
	public void testUpdateEvent() {
		...
		try {
			...
			// update event
			String updatedEventId = eventDao.update(eventId, event);
	...
	public void testForAll() {
		...
		List<Event> events = eventDao.getAll(1, 2, null);
